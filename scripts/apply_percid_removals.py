...
CORMORANT_COL = {
    ...
    "herring": 0.15, "sprat": 0.15, "flounder": 0.1, "cod": 0.05,
}
...
def apply() -> None:
    ...
    set_key(bg, "predation.ingestion.rate.max.sp15", "70.0")   # ~physiological (was 40)
    set_key(bg, "species.biomass.multiplier.sp15", "2.0")       # count-based standing-stock anchor
    ...
    print(f"percid removals applied: fsh4=0.40 fsh5=0.50; cormorant sp15 mult=2.0 "
