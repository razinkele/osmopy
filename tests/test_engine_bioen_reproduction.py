...
class TestBioenReproduction:
    def test_immature_no_eggs(self):
        ...
        eggs = bioen_egg_production(
            gonad_weight=np.array([0.01]), length=np.array([5.0]),
            age_dt=np.array([1], dtype=np.int32), m0=10.0, m1=2.0,
            egg_weight=0.001, n_dt_per_year=24)
    ...
    def test_mature_with_gonad_produces_eggs(self):
        ...
        eggs = bioen_egg_production(
            gonad_weight=np.array([0.5]), length=np.array([20.0]),
            age_dt=np.array([48], dtype=np.int32), m0=5.0, m1=2.0,
            egg_weight=0.001, n_dt_per_year=24)
    ...
    def test_mature_zero_gonad_no_eggs(self):
        ...
        eggs = bioen_egg_production(
            gonad_weight=np.array([0.0]), length=np.array([20.0]),
            age_dt=np.array([48], dtype=np.int32), m0=5.0, m1=2.0,
            egg_weight=0.001, n_dt_per_year=24)
        assert eggs[0] == 0.0
    ...
    def test_vectorized(self):
        ...
        eggs = bioen_egg_production(
            ...
            m0=5.0, m1=2.0, egg_weight=0.01, n_dt_per_year=24)
