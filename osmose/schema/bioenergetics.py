...
BIOENERGETICS_FIELDS: list[OsmoseField] = [
    ...
    OsmoseField(
        ...
        param_type=ParamType.FLOAT,
        description="Increasing activation energy e_M for Johnson curve",
        category="bioenergetics",
        indexed=True,
        min_val=0.0,
        unit="eV",
    ...
    OsmoseField(
        ...
        category="bioenergetics",
        indexed=True,
        unit="°C",  # T_P can be negative for polar species; no min_val
    ),
    OsmoseField(
        key_pattern="species.bioen.maint.e.maint.sp{idx}",
        param_type=ParamType.FLOAT,
        description="Maintenance Arrhenius activation energy",
        category="bioenergetics",
        indexed=True,
        min_val=0.0,
        unit="eV",
