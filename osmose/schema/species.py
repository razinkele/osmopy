...
SPECIES_FIELDS: list[OsmoseField] = [
    ...
    # ── Mortality ────────────────────────────────────────────────────────
    OsmoseField(
        key_pattern="mortality.additional.rate.sp{idx}",
        param_type=ParamType.FLOAT,
        default=0.2,
        min_val=0.0,
        max_val=10.0,
        description="Additional mortality rate (excl. predation/starvation; post-v4.2.5)",
        category="mortality",
        unit="year^-1",
        indexed=True,
    ),
    OsmoseField(
        key_pattern="mortality.additional.larva.rate.sp{idx}",
        param_type=ParamType.FLOAT,
        default=2.0,
        min_val=0.0,
        max_val=50.0,
        description="Additional mortality rate for larvae (post-v4.2.5 name)",
        category="mortality",
        unit="year^-1",
        indexed=True,
    ),
    ...
    # ── Recruitment: percid thermal gate (Pekcan-Hekim 2011; Olin 2019) ──────
    OsmoseField(
